...
const TRANSLATION_DICTIONARY: Record<Language, Record<string, string>> = {
  en: {
    ...
    support_eyebrow: "Help & Support",
    support_title: "Product Support",
    support_sub: "Tell us about the issue you're facing and our team will respond within one business day.",
    support_form_heading: "Open a Support Ticket",
    support_product_type: "Product Type",
    support_product_type_placeholder: "Select a product type",
    support_product_type_mobile: "Mobile App",
    support_product_type_extension: "Visual Studio Marketplace Extension",
    support_product_type_custom: "Custom Work / Consulting",
    support_product_type_other: "Other",
    support_software_name: "Software / Product Name",
    support_software_name_placeholder: "e.g. Generalsoft Authenticator",
    support_version: "Version (optional)",
    support_version_placeholder: "e.g. 1.4.2",
    support_subject: "Subject",
    support_subject_placeholder: "Brief summary of your issue",
    support_form_submit: "Submit Support Ticket",
    support_form_success: "Ticket received! We'll follow up shortly.",
    support_help_email: "Email Support",
    support_help_phone: "Call Support",
    support_help_hours_label: "Business Hours",
    support_help_hours: "Mon–Fri, 9am–6pm PT",
    support_resources_title: "Self-Service Resources",
    support_resources_marketplace: "Visual Studio Marketplace",
    support_resources_apps_ios: "App Store (iOS)",
    support_resources_apps_android: "Google Play (Android)",
    support_resources_docs: "Documentation & Guides",
    support_resources_custom: "Custom Work Inquiries",
  ...
  de: {
    ...
    support_eyebrow: "Hilfe & Support",
    support_title: "Produkt-Support",
    support_sub: "Beschreiben Sie Ihr Anliegen – unser Team antwortet innerhalb eines Werktags.",
    support_form_heading: "Support-Ticket eröffnen",
    support_product_type: "Produkttyp",
    support_product_type_placeholder: "Produkttyp auswählen",
    support_product_type_mobile: "Mobile App",
    support_product_type_extension: "Visual Studio Marketplace-Erweiterung",
    support_product_type_custom: "Individuelle Arbeit / Beratung",
    support_product_type_other: "Sonstiges",
    support_software_name: "Software- / Produktname",
    support_software_name_placeholder: "z. B. Generalsoft Authenticator",
    support_version: "Version (optional)",
    support_version_placeholder: "z. B. 1.4.2",
    support_subject: "Betreff",
    support_subject_placeholder: "Kurze Zusammenfassung Ihres Anliegens",
    support_form_submit: "Support-Ticket senden",
    support_form_success: "Ticket erhalten! Wir melden uns in Kürze.",
    support_help_email: "E-Mail-Support",
    support_help_phone: "Telefon-Support",
    support_help_hours_label: "Geschäftszeiten",
    support_help_hours: "Mo–Fr, 9–18 Uhr PT",
    support_resources_title: "Selbsthilfe-Ressourcen",
    support_resources_marketplace: "Visual Studio Marketplace",
    support_resources_apps_ios: "App Store (iOS)",
    support_resources_apps_android: "Google Play (Android)",
    support_resources_docs: "Dokumentation & Anleitungen",
    support_resources_custom: "Anfragen zu individueller Arbeit",
